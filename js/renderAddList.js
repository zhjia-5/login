/**
 * 
 * @param {*} index 根据index渲染哪一项  number类型 默认值0
 * @param {*} disabled  Boolean 判读是添加页还是编辑页，编辑页的话将select input 设置为disabled 
 * @param {*} obj  数据  对象
 *
 */
function renderList(index = 0, disabled = false, obj = null) {
  ...
  `
  // 承载地址
  // const bearingAddress = `
  // <li class="border-bottom">
  //   <label class="label">承载地址</label>
  //   <input class="input" type="text" placeholder="选填" value=${newline['bizBand']??''}>
  // </li>
  // `
